...
- 通过IP地址：https://192.168.0.4:8443 访问网页版配置，点击系统->管理员->管理员->新建，创建用户user1，密码为admin@123，角色为系统管理员，服务类型默认为Web

  ![image-20220729104726284](README.assets/image-20220729104726284.png)
...
- 在https://192.168.0.4:8443中注销掉当前的用户admin，使用新创建的用户user1进行登录

  ![image-20220729104823247](README.assets/image-20220729104823247.png)
